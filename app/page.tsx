...
import { AlertTriangle, BarChart3, Bell, CalendarDays, Check, ChevronDown, CircleHelp, Clock3, Contrast, Layers3, MapPin, Menu, MoreHorizontal, Navigation, Plus, Route, Search, Sparkles, SunMoon, UsersRound, Wrench, X, Zap } from "lucide-react";
...
export default function Home() {
  ...
  const navigate = useCallback((nextView: "plan" | "requests" | "team" | "analytics") => { setView(nextView); setMobileNavOpen(false); }, []);
